...
<div className='navTop'>
    ...
    <div>
        <h2 className='tituloEncomiendas'>carga completa</h2>  
             ...
             <img className='foto_caja' src="images/servicios/carga_completa.jpg" alt="Carga Completa"/>
             </div>
